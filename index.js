...
// ---- Worker entry point --------------------------------------------
// Handles /api/* itself; everything else is served from the static
// assets bound as env.ASSETS (see [assets] in wrangler.toml), which is
// the current first-class way to combine a site + API in one Worker.
export default {
